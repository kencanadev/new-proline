...
const emptyStateDetails = {
  ...
  [EmptyStateType.WORKSPACE_DASHBOARD]: {
    ...
    description:
      " Welcome to Proline, we are excited to have you here. Create your first project and track your issues, and this page will transform into a space that helps you progress. Admins will also see items which help their team progress.",
    path: "/empty-state/onboarding/dashboard",
    // path: "/empty-state/onboarding/",
    primaryButton: {
      text: "Build your first project",
      comicBox: {
        title: "Everything starts with a project in Proline",
  ...
  [EmptyStateType.WORKSPACE_SETTINGS_API_TOKENS]: {
    ...
    description:
      "Proline APIs can be used to integrate your data in Proline with any external system. Create a token to get started.",
  ...
  [EmptyStateType.PROFILE_ACTIVITY]: {
    ...
    description:
      "Get started by creating a new issue! Add details and properties to it. Explore more in Proline to see your activity.",
  ...
  [EmptyStateType.PROJECT_NO_ISSUES]: {
    ...
    primaryButton: {
      ...
      comicBox: {
        title: "Issues are building blocks in Proline.",
        description:
          "Redesign the Proline UI, Rebrand the company, or Launch the new fuel injection system are examples of issues that likely have sub-issues.",
      },
    },
    accessType: "project",
    access: [EUserPermissions.ADMIN, EUserPermissions.MEMBER],
  ...
  [EmptyStateType.DISABLED_PROJECT_PAGE]: {
    ...
    description:
      "Pages are thought spotting space in Proline. Take down meeting notes, format them easily, embed issues, lay them out using a library of components, and keep them all in your project’s context. Enable the pages feature to start creating them in your project.",
    accessType: "project",
    access: [EUserPermissions.ADMIN],
