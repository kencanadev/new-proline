    ...
    <div className="space-y-4">
      ...
      <div className="text-center space-y-1 py-4 mx-auto">
        ...
        <p className="font-medium text-onboarding-text-400">
          To start using Proline, you need to create or join a workspace.
        </p>
      </div>
      <form className="w-full mx-auto mt-2 space-y-4" onSubmit={handleSubmit(handleCreateWorkspace)}>
        ...
        <div className="space-y-1">
          ...
          <Controller
            ...
            render={({ field: { value, ref, onChange } }) => (
              <div
                className={`relative flex items-center rounded-md border-[0.5px] px-3 ${invalidSlug ? "border-red-500" : "border-onboarding-border-100"
                  }`}
              >
